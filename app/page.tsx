...
const faqData = [
    {
      question: 'כמה אני אוהב את ליאל?',
      answer: 'המון',
    },
    {
      question: 'באילו תוכנות משתמשים?',
      answer: 'אנחנו מתמקדים בתוכנות התקניות בתעשייה כמו Unity, Unreal Engine, וכלים נפוצים לאנימציה ועיצוב. רובן חינמיות או זמינות בגרסאות סטודנט.',
    },
    {
      question: 'כמה זמן לוקח הקורס?',
      answer: 'הקורס מחולק למודולים הניתנים ללימוד בקצב אישי. בדרך כלל, תלמידים משלימים את החומר המרכזי תוך 3-6 חודשים, אך הגישה נשארת פתוחה לתמיד.',
    },
    {
      question: 'מה מקבלים בסוף הקורס?',
      answer: 'בסיום הקורס, תקבל תעודת גמר ופורטפוליו מרשים עם פרויקטים אישיים שתוכל להציג למעסיקים פוטנציאליים.',
    },
    {
      question: 'מה מקבלים בסוף הקורס?',
      answer: 'בסיום הקורס, תקבל תעודת גמר ופורטפוליו מרשים עם פרויקטים אישיים שתוכל להציג למעסיקים פוטנציאליים.',
